...
assert value_product_1 == value_cart_product_1  #(сравниваем цену товара в каталоге и корзине)
...
'''INFO Finish Product 1 (Информация о завершении товаре в корзине)'''
finish_product_1 = driver.find_element(By.XPATH, '//*[@id="item_4_title_link"]')
value_finish_product_1 = finish_product_1.text
print(value_finish_product_1)
assert value_product_1 == value_finish_product_1  #(сравниваем цену товара в каталоге и корзине)
print('INFO Finish Product 1 GOOD')

price_finish_product_1 = driver.find_element(By.XPATH, '//*[@id="cart_contents_container"]/div/div[1]/div[3]/div[2]/div[2]/div')
value_finish_price_product_1 = price_finish_product_1.text
print(value_finish_price_product_1)
assert value_finish_product_1 == value_finish_price_product_1
